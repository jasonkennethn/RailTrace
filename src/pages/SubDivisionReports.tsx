...
import { BarChart3, TrendingUp, Users, CheckCircle, AlertTriangle, Star, Download, RefreshCw } from 'lucide-react';
import ChartContainer from '../components/charts/ChartContainer';
import { aiService } from '../services/aiService';
import { useTheme } from '../contexts/ThemeContext';
import clsx from 'clsx';

const SubDivisionReports: React.FC = () => {
  ...
  useEffect(() => {
    generateSubDivisionReport();
  }, [selectedPeriod]);

  const generateSubDivisionReport = async () => {
    setLoading(true);
    try {
      // Mock data for sub-division reports
      const mockData = {
        denPerformance: [
          { name: 'DEN Central', value: 94 },
          { name: 'DEN East', value: 88 },
          { name: 'DEN West', value: 92 },
          { name: 'DEN North', value: 85 },
          { name: 'DEN South', value: 90 }
        ],
        inspectionTrends: [
          { name: 'Jan', inspections: 120, completed: 115 },
          { name: 'Feb', inspections: 98, completed: 95 },
          { name: 'Mar', inspections: 134, completed: 128 },
          { name: 'Apr', inspections: 156, completed: 148 },
          { name: 'May', inspections: 142, completed: 138 },
          { name: 'Jun', inspections: 178, completed: 170 }
        ],
        projectStatus: [
        ...
        productUsage: [
          { name: 'Rail Joints', value: 850 },
          { name: 'Track Bolts', value: 2400 },
          { name: 'Sleepers', value: 1600 },
          { name: 'Fasteners', value: 4000 }
        ]
      };

      // Get AI insights
      const insights = await aiService.generateInspectionInsights([
        { status: 'passed', productId: 'RJ-001', location: 'DEN Central' },
        { status: 'failed', productId: 'TB-002', location: 'DEN East' },
        { status: 'passed', productId: 'SL-003', location: 'DEN West' }
      ]);

      setReportData(mockData);
      setAiInsights(insights);
    } catch (error) {
      console.error('Error generating sub-division report:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const exportReport = () => {
    ...
    a.href = url;
    a.download = 'subdivision-report.csv';
    a.click();
  };
    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Track inspections and product usage per DEN with AI performance insights
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-4 sm:p-6 shadow-sm mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div className="flex space-x-2">
            <button
              onClick={generateSubDivisionReport}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-4 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Total DEMs</p>
        ...
        <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-4 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">89.8</p>
            </div>
        ...
        <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-4 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">85</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-8">
        <ChartContainer
          type="bar"
          data={reportData?.denPerformance || []}
          title="DEN Performance Ratings"
          height={300}
        />
        <ChartContainer
          type="pie"
      ...
      {aiInsights && (
        <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-4 sm:p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">Alerts</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">Predictions</h4>
              <ul className="space-y-2">
